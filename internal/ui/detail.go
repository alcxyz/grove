...
var helpPages = [2][]struct {
	...
	// ── Page 1: Navigation & Actions ─────────────────────────────────────────
	{
		...
		{"Actions", [][2]string{
			{"enter", "open detail (tabs 1–4, 6–7) · open diff (tab 5)"},
			{"o", "open in browser"},
	...
	// ── Page 2: Filters, Sort & Reference ────────────────────────────────────
	{
		{"Filters & sort", [][2]string{
			...
			{"a / A", "cycle by repository  ·  sort ↑↓ by repository  (tabs 2–7)"},
			{"f / F", "cycle by date  ·  sort ↑↓ by date/updated"},
			{"x / X", "cycle · sort  PR count / review / state  (tabs 1 2 4 7)"},
			{"c / C", "cycle · sort  branch count / branch / merged / due  (tabs 1 3 4 7)"},
